...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7011538007:AAEmuNHXeQT78ROETx5aY3BP3vDpS8w0VuI")

CREDIT = os.environ.get("CREDIT", "『ASTRONAUT』")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "Rashmikakichut002")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Rashmikikichut002:Rashmikakichutvijay@cluster0.90f0dzs.mongodb.net/?appName=Cluster0")
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "6302749609"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6302749609").split()]  # Default to owner ID

# Channel Configuration
PREMIUM_CHANNEL = "https://t.me/+PQlqfkJE-4U2MWRk"
